...
class calc:
    def __init__(self):
        ...
        self.screen = Entry(self.root, textvariable=self.display, bg="lavender", font=('Arial', 35, 'bold'), width=23,
                            bd=16, justify="right")
        self.screen.place(x=10, y=11)
        self.md_btn = Button(self.root, text="Deg", width=11, height=2, bg="gray25", fg="white",
                             command=self.change_mod)
        self.md_btn.place(x=12, y=108)
        self.Deg_btn = Button(self.root, text="X!", width=11, height=2, bg="gray25", fg="white",
                              command=lambda: self.input("self.factorial("))  #
        self.Deg_btn.place(x=102, y=108)  #
        Button(self.root, text="(", width=11, height=2, bg="gray25", fg="white", command=lambda: self.input("(")).place(
            x=192, y=108)
        Button(self.root, text=")", width=11, height=2, bg="gray25", fg="white", command=lambda: self.input(")")).place(
            x=282, y=108)
        Button(self.root, text="%", width=11, height=2, bg="gray25", fg="white").place(x=372, y=108)
        Button(self.root, text="AC", width=11, height=2, bg="red", fg="white", command=self.deletion).place(x=462,
                                                                                                            y=108)
        ...
        Button(self.root, text="7", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input("7")).place(
            x=282, y=152)
        Button(self.root, text="8", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input("8")).place(
            x=372, y=152)
        Button(self.root, text="9", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input("9")).place(
            x=462, y=152)
        Button(self.root, text="/", width=11, height=2, bg="gray25", fg="white", command=lambda: self.input("/")).place(
            x=552, y=152)
        Button(self.root, text="π", width=11, height=2, bg="gray25", fg="white",
               command=lambda: self.input('pi')).place(x=12, y=196)
        self.cos_btn = Button(self.root, text="cos", width=11, height=2, bg="gray25", fg="white",
                              command=lambda: self.input("cos("))
        self.cos_btn.place(x=102, y=196)
        self.log_btn = Button(self.root, text="log", width=11, height=2, bg="gray25", fg="white",
                              command=lambda: self.input('log('))
        self.log_btn.place(x=192, y=196)
        Button(self.root, text="4", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input("4")).place(
            x=282, y=196)
        Button(self.root, text="5", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input("5")).place(
            x=372, y=196)
        Button(self.root, text="6", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input("6")).place(
            x=462, y=196)
        Button(self.root, text="X", width=11, height=2, bg="gray25", fg="white", command=lambda: self.input("*")).place(
            x=552, y=196)
        Button(self.root, text="e", width=11, height=2, bg="gray25", fg="white", command=lambda: self.input("e")).place(
            x=12, y=240)
        self.tan_btn = Button(self.root, text="tan", width=11, height=2, bg="gray25", fg="white",
                              command=lambda: self.input("tan("))
        self.tan_btn.place(x=102, y=240)
        self.sqrt_btn = Button(self.root, text="√", width=11, height=2, bg="gray25", fg="white",
                               command=lambda: self.input("sqrt("))
        self.sqrt_btn.place(x=192, y=240)
        Button(self.root, text="1", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input("1")).place(
            x=282, y=240)
        Button(self.root, text="2", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input("2")).place(
            x=372, y=240)
        Button(self.root, text="3", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input("3")).place(
            x=462, y=240)
        Button(self.root, text="-", width=11, height=2, bg="gray25", fg="white", command=lambda: self.input("-")).place(
            x=552, y=240)
        ...
        Button(self.root, text="0", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input("0")).place(
            x=282, y=284)
        Button(self.root, text=".", width=11, height=2, bg="gray40", fg="white", command=lambda: self.input(".")).place(
            x=372, y=284)
        Button(self.root, text="=", width=11, height=2, bg="gray40", fg="white", command=self.resolve).place(x=462,
                                                                                                             y=284)
        Button(self.root, text="+", width=11, height=2, bg="gray25", fg="white", command=lambda: self.input("+")).place(
            x=552, y=284)
