...
import xhB20030826.bean.Device;
...
public class DeviceshowAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        @SuppressLint({"ViewHolder", "InflateParams"}) View v = LayoutInflater.from(context).inflate(R.layout.device_cell_layout,null);
